    ...
    b.fn.fullpage = function(c) {
        ...
        function m(a) {
            ...
            if(c.autoScrolling){
                ...
                a = a || window.event;
                var value = a.wheelDelta || -a.deltaY || -a.detail;
                var delta = Math.max(-1, Math.min(1, value));

                var horizontalDetection = typeof a.wheelDeltaX !== 'undefined' || typeof a.deltaX !== 'undefined';
                var isScrollingVertically = (Math.abs(a.wheelDeltaX) < Math.abs(a.wheelDelta)) || (Math.abs(a.deltaX ) < Math.abs(a.deltaY) || !horizontalDetection);
